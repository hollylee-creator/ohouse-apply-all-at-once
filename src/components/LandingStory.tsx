import { Search, Calendar, MessageSquare, Gift } from "lucide-react";
      ...
      <section className="bg-gradient-to-b from-background via-brand-softer to-brand-soft/60 pb-10 pt-10 text-center">
        <div className="mx-auto w-full max-w-[430px] px-5">
          ...
          <button
            type="button"
            onClick={onCtaClick}
            className="mx-auto mt-7 flex h-14 w-[calc(100%-40px)] max-w-[340px] items-center justify-center rounded-2xl bg-brand px-6 text-[17px] font-bold text-brand-foreground"
          >
            지금 무료로 견적 받기
